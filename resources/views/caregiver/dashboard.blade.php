...
<head>
    ...
    <!-- Tema & Skrip Awal (sinkron dengan dashboard orang tua) -->
    <script>
    ...
    <style>
        /* CSS Variables Material Design 3 - SAMA dengan dashboard orang tua */
        :root {
...
<!-- SIDEBAR - Konsisten dengan Dashboard Orang Tua -->
...
<main class="ml-0 lg:ml-72 min-h-screen transition-all duration-300">
    <!-- Header Atas (konsisten dengan dashboard orang tua) -->
    ...
    <!-- KONTEN UTAMA (data caregiver, visual konsisten dengan dashboard orang tua) -->
    <div class="p-5 sm:p-8 space-y-7 animate-fade-in-up">
        ...
        <!-- Statistic Cards (3 kartu: Anak Diasuh, Aktivitas Dicatat, Perlu Perhatian) - gaya premium seperti orang tua -->
        ...
        <!-- RINGKASAN CERIA AI (4 insight cards) - gaya konsisten dengan orang tua -->
        <div>
        ...
        <!-- 2 KOLOM: STATUS ANAK + INPUT AKTIVITAS HARIAN (gaya konsisten dengan orang tua) -->
        ...
        <!-- DETEKSI CERIA AI HARI INI (progress bars) - gaya konsisten dengan orang tua -->
        <div>
            <div class="flex items-center gap-2 mb-4">
        ...
        <!-- AKTIVITAS TERBARU (timeline) - gaya konsisten dengan orang tua -->
        <div class="bg-surface-container-lowest rounded-3xl p-6 card-shadow border border-outline-variant/20">
            <div class="flex items-center gap-3 mb-5">
                <div class="w-1.5 h-6 bg-primary rounded-full"></div>
        ...
        <!-- Ringkasan Kesehatan & Perkembangan (section tambahan bergaya orang tua) -->
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-7">
...
<script>
    // Theme toggle (sama persis dengan dashboard orang tua)
