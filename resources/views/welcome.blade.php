    ...
    <nav class="fixed w-full z-50 transition-all duration-300 glass-panel border-b border-slate-300/60">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="flex items-center gap-3">
                    <a href="/daftar" class="hidden sm:inline-flex items-center justify-center px-6 py-2.5 text-sm font-semibold text-white bg-primary-900 rounded-full hover:bg-primary-800 hover:shadow-lg hover:shadow-primary-900/30 transition-all duration-200 active:scale-95">
                        Masuk Portal
                    </a>
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-white/95 backdrop-blur-xl border-b border-slate-200 absolute w-full left-0 top-[80px] shadow-xl overflow-hidden transition-all duration-300 transform origin-top" style="max-height: 0; opacity: 0;">
            <div class="px-4 pt-2 pb-6 space-y-1">
                ...
                <a href="/daftar" class="block mt-4 px-4 py-3 text-center rounded-xl text-base font-bold text-white bg-primary-900 hover:bg-primary-800 transition-colors sm:hidden">Masuk Portal</a>
            </div>
        </div>
    </nav>
                ...
                <div class="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
                    ...
                    <span class="uppercase tracking-wide">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                            <a href="/daftar" class="inline-flex items-center justify-center px-8 py-3.5 text-base font-semibold text-white bg-primary-900 rounded-full hover:bg-primary-800 hover:shadow-xl hover:shadow-primary-900/30 transition-all duration-200 group">
                                Mulai Sekarang
